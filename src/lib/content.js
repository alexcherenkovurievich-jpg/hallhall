...
export const PRICE_DAILY = {
  ...
  // правило по детям одинаково в оба сезона, поэтому строкой, а не объектом:
  // переключатель сезона его не трогает
  footnote: 'Каждый следующий гость +500 ₽ (посуточно или только на дневное пребывание). Дети до 5 лет не считаются — доплата за гостя начинается с 5 лет.',
};
